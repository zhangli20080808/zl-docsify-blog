...
1. 客户端询问服务器 你在吗，你是否可以用 2.服务器告诉客户端可以访问 2. 客户端再次告诉服务端，知道了 我要访问了 开始发送请求 url method 连接就建立了 由于这三次握手 每一次连接都要握这三次手 所以除了我们数据的大小之外 三次握手的网络包也是网络延迟的主要原因之一，也是我们的文件为什么要打包 少发网络请求的原因 比如雪碧图啊 这都是三次握手导致的
