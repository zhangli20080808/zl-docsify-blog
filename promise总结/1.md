...
- 宏任务：宿主提供的异步方法 ,包括 setTimeout 、setInterval 、DOM 事件、 AJAX 、UI rendering、I/O、script
- 微任务：语言标准提供的 ,Promise（对于前端来说）Async Await 包括 promise 回调，MutationObserver，process.nextTick，
  Object.observe
- 放置时机
